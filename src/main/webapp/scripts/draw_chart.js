...
/**
 * processing the data, draw the chart in <chart id>
 * @param {array} arr - the json array it gets 
 * @param {string} chartId - the chart id which needs to be draw
 */
function draw_with_data(arr, chartId){
 ...
 * @param {array} array 
 * @param {map} companies - [company name, number of showing up ]
 * @param {array} xAxis - the x axis of the chart
 */
...
/**
 * 
 * @param {map} companies - A map contains all companies and thier heat rate
